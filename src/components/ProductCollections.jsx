...
const ProductCollections = ({hero}) => {
  ...
  return (
    <div className={`hero overflow-hidden  my-[-56vh] lg:my-[-115vh]  md:my-[-90vh] max-w-full   ${hero?'hidden':""} ` }  >

    <div className="product-collection  mb-[16rem] overflow-hidden max-w-full ">

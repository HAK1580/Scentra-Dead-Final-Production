  ...
  return (
    <>
      <nav className={`relative ${search ? "hide" : ""}`}>
        ...
        <img 
          onClick={handleClick}
          className={`cursor-pointer ${menuOpen ? 'cross-forward' : 'hamburger'} w-[34px] z-50 absolute bottom-[clamp(1.1rem,1%,2rem)] left-2 md:hidden max-[300px]:w-[26px]`}
        ...
        <img
          ...
          className={`search-icon ${menuOpen ? "hide" : ""} absolute lg:right-[clamp(0.3rem,4%,8rem)] lg:bottom-[clamp(1rem,36%,3rem)] md:w-[28px] lg:w-[33px] max-[768px]:bottom-[25%] max-[768px]:right-[4%] max-[768px]:w-[29px] md:right-[2%] md:bottom-[26%] cursor-pointer max-[300px]:w-[23px]`}
          width={32}

...
if(e.key==="Enter"){
  ...
  return (
    <>
 <div className="search-box-div overflow-x-hidden block relative max-w-full min-h-[110vh] z-100    bg-[rgba(255,255,255,0.238)] m-0   top-[clamp(-2rem,-2rem,-1rem)]">
  <div className="search-box overflow-hidden absolute w-[94%] left-2

 ...
 `}src={image} alt="img" /> )}
           ...
           2xl:top-[clamp(32rem,60vw,44rem)] 
             ...
             <button  className="bg-[#000000d0] font-tree  px-[clamp(1.5rem,3.5vw,5rem)]  text-[clamp(1rem,2.7vw,3rem)] py-[clamp(0.4rem,0.3vw,2rem)] border-1 border-[#d4af3767] rounded-[8px] text-[#ffffffcb] cursor-pointer font-[100] z-100 tracking-wider 

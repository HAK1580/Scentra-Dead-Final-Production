            ...
            <div className="checkout-form-div mt-[-0.5rem]   ">
                ...
                <form className='font-inter tracking-normal flex flex-col gap-12 justify-center  max-w-[94%] mx-auto' onSubmit={handleSubmit(onSubmit)} >
                    ...
                    <div className="delivery">
                        ...
                        <input {...register("last_name", { required: "Enter a last name", pattern: { value: /^[A-Za-z][A-Za-z\s'-]{1,29}$/, message: "Enter a valid last name", }, })} className={`${errors.last_name ? "outline-red-500 outline-3" : "outline-0 outline-black"} ml-1 mt-5  w-[94%] py-2.5 px-3 rounded-[4px]  bg-white text-black`} type="text" placeholder='Last name' />
                        {errors.last_name && <p className='text-[#ff0000cd] mt-4  ml-1'>{errors.last_name.message}</p>}

                        <input {...register("address", { required: "Enter an address", pattern: { value: /^[A-Za-z0-9\s,'-]{5,100}$/, message: "Enter a valid address", }, })} className={`${errors.address ? "outline-red-500 outline-3" : "outline-0 outline-black"} ml-1 mt-5  w-[94%] py-2.5 px-3 rounded-[4px]  bg-white text-black`} type="text" placeholder='Address' />
                        ...
                        <input {...register("city", { required: "Enter a city", pattern: { value: /^[A-Za-z\s'-]{2,50}$/, message: "Enter a valid city", }, })} className={`${errors.city ? "outline-red-500 outline-3" : "outline-0 outline-black"} ml-1 mt-5  w-[94%] py-2.5 px-3 rounded-[4px]  bg-white text-black`} type="text" placeholder='City' />
                        {errors.city && <p className='text-[#ff0000cd] mt-4  ml-1'>{errors.city.message}</p>}

                        <input {...register("email", { required: "Enter an email address", pattern: { value: /^(?:[a-zA-Z0-9_'^&amp;+{}-]+(?:\.[a-zA-Z0-9_'^&amp;+{}-]+)*)@(?:[a-zA-Z0-9-]+\.)+[a-zA-Z]{2,}$/, message: "Enter a valid email address", } })} className={`${errors.email ? "outline-red-500 outline-3" : "outline-0 outline-black"} ml-1 mt-5 py-2.5 w-[94%] px-3 rounded-[4px]  bg-white text-black`} type="text" placeholder='Email address' />

...
const CheckOut = () => {
    ...
    return (
        ...
        <div >
            <div className="center-logo relative  border  w-[100%]  mx-auto  py-5  
        flex justify-center items-center 
         ">
                <img className='w-38 md:w-42 lg:w-55
            sm:left-30  lg:left-10
            lg:top-3
            absolute top-1 left-8 md:left-40  max-[500px]:w-28
            
            ' src="IMGS/logo/logo-fotor-bg-remover-2025080510633.webp" alt="" />
                <h1 className='text-[10vw] sm:text-[8vw] lg:text-[5rem]
            ...
            <div className="checkout-form-div my-1 ">
                <h1 className=' text-[8vw] mb-4 sm:text-[3.4vw] tracking-wider  p-3 font-light '> CheckOut </h1>
                ...
                <form className='font-inter tracking-normal flex flex-col gap-12 justify-center  max-w-[94%] mx-auto' onSubmit={handleSubmit(onSubmit)} >
                    ...
                    <div className="contact">
                        <h1 className='text-[6vw] sm:text-[2.7vw] ml-1 tracking-wide mb-2 ' >Contact</h1>
                    ...
                    <div className="billing-address">
                        <h1 className='text-[6vw] sm:text-[2.7vw] ml-2 tracking-wide mb-2 '> Billing address  </h1>

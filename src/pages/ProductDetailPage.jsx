  ...
  return (
    <div className='overflow-hidden '  >
      ...
      ">
       ...
       <button onClick={addtoCart}  className='border-1 pt-cart  text-[5.7vw] font-inter   text-center text-black bg-[#d4af37]  lg:bg-black   w-[97%]   mx-auto sm:text-[4.5vw] cursor-pointer font-extrabold   py-3  lg:hover:bg-[#d4af37ad] hover:text-[rgb(33,33,33)]" sm:hover:text-black         
        '> Add to Cart</button>
        <button onClick={gotocheckout}  className='border-1 pt-cart text-[5.7vw] font-inter   flex justify-center items-center     w-[97%]   mx-auto sm:text-[4.5vw] cursor-pointer font-extrabold   py-3  lg:hover:bg-[#d4af37ad]        
         '> Check Out</button>

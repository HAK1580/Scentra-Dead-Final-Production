  ...
  return (
    <div className='overflow-hidden '  >
      ...
      ">
       ...
       <button onClick={addtoCart}  className='border-1 pt-cart  text-[5.2vw] font-inter   text-center text-black bg-[#d4af37]  lg:bg-black   w-[90.5%]   mx-auto sm:text-[4vw] cursor-pointer font-extrabold   py-2  lg:hover:bg-[#d4af37ad] hover:text-[rgb(33,33,33)]" sm:hover:text-black         
        '> Add to Cart</button>
        <button onClick={gotocheckout}  className='border-1 pt-cart text-[5.2vw] font-inter   flex justify-center items-center     w-[90.5%]   mx-auto sm:text-[4vw] cursor-pointer font-extrabold   py-2  lg:hover:bg-[#d4af37ad]        
         '> Check Out</button>
